...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug: string, publishedAt?: any | null }> };
...
export function withCreateSubscriber<TProps extends Exact<{ name: string; email: string; }>, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
...
export function withGetLessonBySlug<TProps extends {} | Exact<{ slug?: InputMaybe<string> | undefined; }>, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
...
export function withGetLessons<TProps extends Exact<{ [key: string]: never; }>, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetLessonsQuery,
